CREATE OR REPLACE PACKAGE monopoly AS
 c_start_balance CONSTANT NUMBER:=1500; c_timeout_penalty CONSTANT NUMBER:=50; c_turn_minutes CONSTANT NUMBER:=5; c_auction_seconds CONSTANT NUMBER:=30; c_ready_seconds CONSTANT NUMBER:=10; c_mortgage_interest CONSTANT NUMBER:=0.10;
